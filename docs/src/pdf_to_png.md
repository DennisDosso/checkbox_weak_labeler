# PDF to Image Utility (`pdf_to_png.py`)
...
```bash
python src/utils/pdf_to_png.py --input "data/raw" --output "data/processed" --dpi 300
...
```python
from src.utils.pdf_to_png import convert_pdfs_to_images
